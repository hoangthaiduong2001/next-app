...
import { cn, getVietnameseOrderStatus, OrderStatusIcon } from "@/config/utils";
      ...
      >
        <DialogContent className="max-h-full overflow-auto">
          {selectedServingGuest && (
            <DialogHeader>
              <DialogTitle>
                Guests are sitting at the table {selectedTableNumber}
              </DialogTitle>
            </DialogHeader>
          )}
          <div>
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      Serving: {servingGuestCount} guest
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
